...
// @ts-ignore
import { BookingRequestBuilderNavigationMetadata, BookingRequestBuilderRequestsMetadata, type BookingRequestBuilder } from './booking/index.js';
// @ts-ignore
import { FacilityRequestBuilderNavigationMetadata, FacilityRequestBuilderRequestsMetadata, type FacilityRequestBuilder } from './facility/index.js';
// @ts-ignore
import { NominalRollRequestBuilderRequestsMetadata, type NominalRollRequestBuilder } from './nominalRoll/index.js';
// @ts-ignore
...
export interface ApiClient extends BaseRequestBuilder<ApiClient> {
     ...
     */
    get booking(): BookingRequestBuilder;
    /**
     * The Facility property
     */
    get facility(): FacilityRequestBuilder;
    /**
     * The NominalRoll property
     */
    get nominalRoll(): NominalRollRequestBuilder;
}
/**
...
export function createApiClient(requestAdapter: RequestAdapter) {
    ...
    if (requestAdapter.baseUrl === undefined || requestAdapter.baseUrl === null || requestAdapter.baseUrl === "") {
        requestAdapter.baseUrl = "http://localhost:5204";
    }
...
export const ApiClientNavigationMetadata: Record<Exclude<keyof ApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    ...
    booking: {
        requestsMetadata: BookingRequestBuilderRequestsMetadata,
        navigationMetadata: BookingRequestBuilderNavigationMetadata,
    },
    facility: {
        requestsMetadata: FacilityRequestBuilderRequestsMetadata,
        navigationMetadata: FacilityRequestBuilderNavigationMetadata,
    },
    nominalRoll: {
        requestsMetadata: NominalRollRequestBuilderRequestsMetadata,
    },
};
/* tslint:enable */
/* eslint-enable */
